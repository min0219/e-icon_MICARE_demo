...
public class DatabaseOpenHelper04 extends SQLiteOpenHelper {
    private static final String DATABASE_NAME = "DISEASE01.db";
    private static final int VERSION_NAME = 1;
    private final static String TAG = "DatabaseHelper";
    private SQLiteDatabase myDataBase03;
    private String myPath;
    private Context myContext;

    public DatabaseOpenHelper04(Context context) {
        super(context, DATABASE_NAME, null, VERSION_NAME);
    }

    public DatabaseOpenHelper04(Context context, String filePath) {
        super(context, DATABASE_NAME, null, VERSION_NAME);
    ...
    public ArrayList<CategoryData04> getCategoryName(String str) {
        myDataBase03 = SQLiteDatabase.openDatabase(myPath,
                null, SQLiteDatabase.OPEN_READONLY);
        String query = "SELECT DISTINCT About from Names where Name = " + "'" + str + "'";
        Log.e("hghgh",query);
        Cursor cursor = myDataBase03.rawQuery(query, null);
        ArrayList<CategoryData04> categoryArrayList = new ArrayList<>();
        while (cursor.moveToNext()) {
            CategoryData04 category = new CategoryData04();
